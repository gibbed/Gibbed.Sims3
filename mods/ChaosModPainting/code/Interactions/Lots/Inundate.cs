...
{
    public class Inundate : ImmediateInteraction<Sim, IViewable>, IChaosInteractionProvider
    {
        ...
        [DoesntRequireTuning]
        private class Definition : ImmediateInteractionDefinition<Sim, IViewable, Inundate>
        {
