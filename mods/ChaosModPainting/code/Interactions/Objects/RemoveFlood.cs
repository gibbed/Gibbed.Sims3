...
{
    public class RemoveFlood : ImmediateInteraction<Sim, IViewable>, IChaosInteractionProvider
    {
        ...
        private class Definition : ImmediateInteractionDefinition<Sim, IViewable, RemoveFlood>
        {
