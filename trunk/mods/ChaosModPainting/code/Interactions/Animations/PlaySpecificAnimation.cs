...
{
    public class PlaySpecificAnimation : Interaction<Sim, IViewable>, IChaosInteractionProvider
    {
        ...
        // Nested Types
        [DoesntRequireTuning]
        private sealed class Definition : InteractionDefinition<Sim, IViewable, PlaySpecificAnimation>
        {
            // Fields
