...
namespace Gibbed.Sims3.Helpers
{
    public class SimsCrc64 : HashAlgorithm
    {
        public const UInt64 DefaultSeed = 0xFFFFFFFFFFFFFF; // -1
        ...
        public SimsCrc64()
        {
            this.Seed64 = DefaultSeed;
            this.Initialize();
        }

        public SimsCrc64(UInt64 seed)
        {
            this.Seed64 = seed;
            this.Initialize();
        }
        ...
        {
            this.Hash64 = CalculateHash(this.Hash64, buffer, start, length);
        }

        protected override byte[] HashFinal()
        {
            byte[] buffer = UInt64ToBigEndianBytes(~this.Hash64);
        ...
        {
            return ~CalculateHash(DefaultSeed, buffer, 0, buffer.Length);
        }
